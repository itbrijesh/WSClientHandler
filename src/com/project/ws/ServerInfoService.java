 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://ws.project.com/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://ws.project.com/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://ws.project.com/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.project.com/", "ServerInfoPort"), ServerInfo.class, features);
    }
